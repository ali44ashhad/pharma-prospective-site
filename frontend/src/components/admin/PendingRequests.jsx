...
//       <div className="mb-6">
//         <h2 className="text-2xl font-bold text-gray-900">Pending Access Requests</h2>
...
//                     <h4 className="font-medium text-gray-900 text-sm mb-2">Purpose:</h4>
//                     <p className="text-gray-700 text-sm">{request.purpose}</p>
//                   </div>
//                 </div>
